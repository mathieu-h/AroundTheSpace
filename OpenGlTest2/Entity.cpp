...
Vector3 Entity::get_goal()
{
	return _goal;
}

void Entity::set_goal(Vector3 newGoal)
{
	_goal = newGoal;
}
...
_eyeVector(makeVector3(0.0f, 0.0f, 0.0f)), _upVector(makeVector3(0.0f, 1.0f, 0.0f)), _goal(newVector3)
{
	isLight = false;
}
